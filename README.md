[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=17852677)
# Sp25Lab2
...
* the big-O worst-case complexity is O(N), where N is the lenth of the list, and
...
I would use the function **search** (defined above) in real life because it has logarithmic time complexity, making it suitable for large data sets.
